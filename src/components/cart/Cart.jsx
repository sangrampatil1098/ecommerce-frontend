  ...
  return (
    <div className="lg:px-14 sm:px-8 px-4 py-10">
      <div className="flex flex-col items-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 flex items">
          <MdShoppingCart size={36} className="text-gray-700" />
          Your Cart
        </h1>
        <p className="text-lg text-gray-700 mt-2">All your selected items</p>
      </div>
      ...
      <div className="border-t-[1.5px] border-slate-200 py-4 flex sm:flex-row sm:px-0 px-2 flex-col sm:justify-between">
        <div></div>
